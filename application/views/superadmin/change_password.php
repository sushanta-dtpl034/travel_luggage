                            ...
                            <div class="col-md-12">
                                ...
                                <form id="change_password"> 
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p class="mg-b-10">Current Password <span class="text-danger">*</span></p>
                                                <input type="hidden" class="form-control"   name="change_id" id="change_id" value="<?php echo $this->session->userdata('userid'); ?>">
                                                <input id="password" name="current_password" type="password" class="form-control password" data-parsley-minlength="6" data-parsley-errors-container=".errorspannewpassinput"  data-parsley-required-message="Please enter your current password." data-parsley-uppercase="1"  data-parsley-lowercase="1" data-parsley-number="1" data-parsley-special="1"  data-parsley-required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p class="mg-b-10">Password <span class="text-danger">*</span></p>
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p class="mg-b-10">Confirm Password <span class="text-danger">*</span></p>
