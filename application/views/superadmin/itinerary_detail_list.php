            ...
            <div class="row row-sm">
                <div class="col-md-12">
                    <div class="alert alert-solid-success insert" role="alert" style="display:none">
                        ...
                        <strong>Itinerary   </strong> Generate succesfully.
                    </div>
                    <div class="alert alert-solid-success update" role="alert" style="display:none">
                        <button aria-label="Close" class="btn-close" data-bs-dismiss="alert" type="button">
                        <span aria-hidden="true">&times;</span></button>
                        <strong>Itinerary  </strong> updated succesfully.
                    </div>
                    ...
                    <div class="card custom-card overflow-hidden">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="itinerary_details_table" class="table table-bordered border-t0 key-buttons text-nowrap w-100" >
                                    <thead>
                                        <tr>
                                            <th>S.No</th>
...
<!-- insert Grid modal -->
<div class="modal" id="itinerary_modal">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Itinerary Creation</h6>
            ...
            <div class="modal-footer">
                <button class="btn ripple btn-secondary load-itinerary" disabled type="button" style="display:none;">
                <span aria-hidden="true" class="spinner-border spinner-border-sm" role="status"></span> Loading...</button>
                <button class="btn ripple btn-primary" type="button" id="itinerary_button">Save changes</button>
...
<!--End Grid modal -->
<!-- update Grid modal -->
<div class="modal" id="update-itinerary-modal">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Itinerary Update</h6><button aria-label="Close" class="btn-close btn-secondary" data-bs-dismiss="modal" type="button">&times;</button>
            </div>
            <form id="update-itinerary-form">
                <div class="modal-body">
                    <!-- Show PHP Validation ERRORS Start -->
                    <div class="alert alert-danger print-error-msg" style="display:none">
                        <ul id="form_errors"></ul>
            ...
            <div class="modal-footer">
                <button class="btn ripple btn-secondary load-itinerary" disabled type="button" style="display:none;">
                <span aria-hidden="true" class="spinner-border spinner-border-sm" role="status"></span> Loading...</button>
                <button class="btn ripple btn-primary" type="button" id="update_itinerary">Update</button>
