            ...
            <div class="row row-sm">
                <div class="col-md-12">
                    <div class="alert alert-solid-success insert" role="alert" style="display:none">
                        ...
                        <strong>User   </strong> Generate succesfully.
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="parsley-select" id="Gender">
                                    <select class="form-control Gender" data-parsley-class-handler="#Gender" data-parsley-errors-container="#GenderErrorContainer"  required="" name="Gender">
...
<div class="modal" id="update-traveller-modal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">User Update</h6><button aria-label="Close" class="btn-close btn-secondary" data-bs-dismiss="modal" type="button">&times;</button>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row row-sm">
                        <div class="col-md-6">
                            <div class="form-group">
                                <p class="mg-b-10">Gender <span class="tx-danger">*</span></p>
                                <div class="parsley-select" id="uGender">
                                    <select class="form-control uGender" data-parsley-class-handler="#uGender" data-parsley-errors-container="#uGenderErrorContainer"  required="" name="Gender">
                                        <option value="">Choose Gender</option>
                                        <option value="Male">Male</option>
                                        <option value="Female">Female</option>
                                        <option value="Transgender">Transgender</option>
