					...
					<ul class="nav">
						<?php if($this->session->userdata('userdata')['UserRole'] == 3){ ?>
							...
							<li class="nav-item">
								...
								<span class="sidemenu-label">Manage Itinerary</span></a>
							</li>
							<li class="nav-item">
						...
						<?php if ($this->session->userdata('userdata')['UserRole'] == 1) { ?>
							<br>
							<li class="nav-item">
								<a class="nav-link tt" href="<?php echo base_url(); ?>Dashboard/superadmin_dasboard">
								<span class="shape1"></span><span class="shape2"></span><i class="ti-home sidemenu-icon"></i>
							...
							<li class="nav-item">
								...
								class="sidemenu-label">Travel User Controller</span></a>
							</li>
							...
							<li class="nav-item">
								...
								<span class="sidemenu-label">Airline Master</span></a>
							</li>
							<li class="nav-item">
			...
			<div class="main-sidebar-body">
				<ul class="nav">
					<li class="nav-item active">
						<a class="nav-link tt" href="<?php echo base_url(); ?>Login">
						<span class="shape1"></span><span class="shape2"></span>
