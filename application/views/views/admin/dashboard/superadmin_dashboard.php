        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
                    <label class="main-content-label mb-3 pt-1">Verification Pending</label>
                    <h2 class="text-end"><a href="<?php echo (count($pending)!=0) ? base_url('Assetmanagement/assetnotification_list') :'javascript:void(0)'; ?>"><i class="mdi mdi-cube icon-size float-start text-primary"></i><span class="font-weight-bold"><?php echo count($pending); ?></span></a></h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="card-order">
                    ...
                    if($this->session->userdata('GroupID')==4){
                        $name = "My Assets";
                        $url=base_url()."Asset/myassets_list";
                    }else{
                        $name = "Total Assets";
                        $url = base_url('Assetmanagement/assetform_list');
                    }
                    ?>
                    <label class="main-content-label mb-3 pt-1"><?php echo $name; ?></label>
                    <h2 class="text-end"><a href="<?php echo $url;  ?>"><i class="mdi mdi-cube icon-size float-start text-primary"></i><span class="font-weight-bold"><?php echo count($asset); ?></span></a></h2>
                </div>
            </div>
        </div>
    </div>
    <?php if($this->session->userdata('GroupID')!=4){ ?>
    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-order">
