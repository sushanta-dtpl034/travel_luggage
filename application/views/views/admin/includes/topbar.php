    ...
    <div class="container-fluid">
        ...
        <div class="main-header-center">
            <div class="responsive-logo">
                <!--<a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/img/brand/logo.png" class="mobile-logo" alt="logo"></a>
            ...
            <div class="dropdown main-profile-menu">
                <a class="d-flex" href="">
                    <span class="main-img-user">
                        <?php if(!empty($this->session->userdata('profile')) && file_exists('upload/profile/'.$this->session->userdata('profile'))) { ?>
                ...
                <div class="dropdown-menu">
                    <div class="header-navheading">
                        <h6 class="main-notification-title">
                            ...
                            if(!empty($CompanyName)){ echo $CompanyName;}else{ echo $username; }?>
                            </b>
                        </h6>
                    ...
                    <a class="dropdown-item border-top" href="#">
                        ...
                        <?php if($this->session->userdata('serviceID') ==1 ){ ?>
                            <p style="color:green;">Asset Management</p>
                        <?php }else if($this->session->userdata('serviceID')==2){ ?>
                            <p style="color:blue;">As Built Inventory</p>
                        <?php }else if($this->session->userdata('serviceID')==3){ ?>
