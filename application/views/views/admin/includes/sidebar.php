...
<div class="main-sidebar main-sidebar-sticky side-menu">
    <div class="sidemenu-logo" style="width: 232px;">
        <a class="main-logo" href="<?php echo base_url('/Dashboard/superadmin_dasboard'); ?>">
            ...
            ?>
            <img src="<?php echo $url; ?>" class="header-brand-img desktop-logo" alt="logo" width="<?= isset($width)?$width:'100'; ?>" height="<?= isset($height)?$height:'100'; ?>">
            <img src="<?php echo $url; ?>" class="header-brand-img icon-logo" alt="logo" width="<?= isset($width)?$width:'100'; ?>" height="<?= isset($height)?$height:'100'; ?>">
            <img src="<?php echo $url; ?>" class="header-brand-img desktop-logo theme-logo" alt="logo" width="<?= isset($width)?$width:'100'; ?>" height="<?= isset($height)?$height:'100'; ?>">
            <img src="<?php echo $url; ?>" class="header-brand-img icon-logo theme-logo" alt="logo" width="<?= isset($width)?$width:'100'; ?>" height="<?= isset($height)?$height:'100'; ?>">
        </a>
    </div>
    <div class="main-sidebar-body">
        ...
        <?php  if (isset($userrole)) { ?>
            ...
            <?php } else if ($userrole == 2 || $userrole == 3 || $userrole == 4) { ?>
                <br>
                <li class="nav-item">
                ...
                <?php  if ($this->session->userdata('serviceID') == 1) { //start assetmanagement  ?>
                    <?php if ($admin == 1) { ?>
                        <li class="nav-item">
                            <a class="nav-link"
                    ...
                    <?php if (($admin != 1 && $supervisor == 1) || ($admin != 1 && $auditor == 1)) { ?>
                ...
                <?php } ///////end assetmanagement ?>


                <?php if ($this->session->userdata('serviceID') == 2) { ?>
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span class="shape2"></span><i
                ...
                <?php if ($this->session->userdata('serviceID') == 3) { ?>
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span class="shape2"></span><i
