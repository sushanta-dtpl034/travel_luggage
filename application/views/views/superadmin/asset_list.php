    ...
    <div class="container-fluid">
        ...
        ?>
                       <a href="<?php echo base_url('Assetmanagement/exportAssetdetails'); ?>"> 
                            <button type="button" class="btn btn-warning my-2 btn-icon-text btn-sm" id="excel_btn"  href="">
                                Excel Export
                            </button>
                         </a> 
                        ...
                        <button type="button" class="btn btn-info my-2 btn-icon-text assetimport btn-sm">
    					  Import
    					</button>
                        <?php
           }
                        ?>
                        <button type="button" class="btn btn-primary my-2 btn-icon-text btn-sm" id="assetadd_btn"  href="">
    					  Add Asset
    					</button>
    				</div>
    			</div>
                            ...
                            <div class="col">
                                    <div class="row" style="text-align:right;">
                                        ...
                                        <label> Search: </label>
                                            ...
                                            <label> Status: </label>
                                            <select id="asset-filter-data" class="form-select form-controle">
				...
				<div class="row row-sm">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control datepicker"  placeholder="MM-DD-YYYY" type="date" id="purchased_date">
                    ...
                    <div class="col-md-6">
                        <div class="form-group select2CustomErrorShow">
                            ...
                            <select class="form-control select2 select2-with-search"  name="asstman_incharge" id="asstman_incharge">
                                <option label="Choose one" value=""></option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group select2CustomErrorShow">
                            ...
                            <select class="form-control select2 select2-with-search"  name="assetman_supervisor" id="assetman_supervisor">
                                <option label="Choose one" value=""></option>
        ...
        <form id="addassetview_form" enctype="multipart/form-data">
			<div class="modal-body">
				<div class="row row-sm">
                    ...
                    <div class="table-responsive" id="assettransfer-his">
        ...
        <div class="modal-body">
            <div class="row row-sm">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <p class="mg-b-10">Asset Category <span class="tx-danger">*</span></p>
                        <select class="form-control select2 assetman_cat" required="" name="up_assetmancat" id="up_assetmancat">
                        <option label="Choose one" value=""></option>
                        <?php 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 assetment_subcat" required="" name="up_assetmentsubcat" id="up_assetmentsubcat">
                            <option label="Choose one" value=""></option>
                        <?php 
