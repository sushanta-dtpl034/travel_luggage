							...
							<div class="row row-sm">
                                       ...
                                       <div class="col-6 p-0"> Picture <span class="tx-danger">*(jpg,png,jpeg,pdf)</span></div>
                                        <!-- <input type="file" class="dropify" data-height="200" id="picture" multiple required=""> -->
                                           <div class="col-6 p-0" style="text-align:right"> 
                                            <button class="btn btn-success btn-circle btn-sm addmore" type="button" name="add" onclick="addFileupload();">+</button><br>
                                            <div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" required="" name="warrantly_covered_for" id="warrantly_covered_for" multiple="multiple">
                                            <option label="Choose one" value=""></option>
                                        </select>
                                    </div>
								</div>
        ...
        <div class="modal-body">
            <div class="row row-sm">
                ...
                <div class="col-md-6">
                                    <div class="form-group">
                                        <p class="mg-b-10"> Warranty Covered for<span class="tx-danger">*</span></p>
                                        <select class="form-control select2" required="" name="up_warrantly_covered_for" id="up_warrantly_covered_for" multiple="multiple">
