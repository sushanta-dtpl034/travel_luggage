        ...
        <div class="main-content side-content pt-0">
                    ...
                    <div class="page-header">
                        ...
                        <div class="d-flex">
                                            <div class="justify-content-center">
                                                ...
                                                <button type="button" class="btn btn-primary my-2 btn-icon-text btn-sm" data-bs-target="#materialmodal" data-bs-toggle="modal" >
                                                  Add  Material Conditon
                                                </button>
                                                <a href="<?php echo base_url()."/Material/Material_excel_export"; ?>"><button type="button" class="btn btn-sm btn-warning my-2 btn-icon-text">Export</button></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row row-sm">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"  name="mater_conditionname" required="">
            ...
            <div class="modal" id="updatematerialmodal">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content modal-content-demo">
                                    <div class="modal-header">
                                        <h6 class="modal-title">Material Condition </h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"></button>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="row row-sm">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control"  name="mater_conditionname" required="" id="up_conditionname">
