        ...
        <div class="page-header">
            ...
            <div class="d-flex">
                <div class="justify-content-center">
                    <button type="button" class="btn btn-primary my-2 btn-icon-text btn-sm" data-bs-target="#assetsub_model" data-bs-toggle="modal" href="">
                        Add Asset Sub Category 
                    </button>
                    <a href="<?php echo base_url('Asset/subcat_templatedownload'); ?>"> <button type="button" class="btn btn-success my-2 btn-icon-text btn-sm" >
                        Download Template
                    </button></a>
                    <button type="button" class="btn btn-info my-2 btn-icon-text subcatimport btn-sm">
                        Import
                    </button>
                    <a href="<?php echo base_url()."/Asset/Assetsubcat_excel_export"; ?>"><button type="button" class="btn btn-sm btn-warning my-2 btn-icon-text">Export</button></a>
                </div>
            </div>
                ...
                <div class="card custom-card overflow-hidden">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table id="assetsubcat_table" class="table table-bordered border-t0 key-buttons text-nowrap w-100" >
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                ...
                <div class="row row-sm">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  name="assetsubcat_name" required="" id="assetsubcat_name" >
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <p class="mg-b-10">Sub Category <span class="tx-danger">*</span></p>
                            <input type="text" class="form-control"  name="up_assetsubcatname" required="" id="up_assetsubcatname" >
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <p class="mg-b-10">Depreciation rate (%)<span class="tx-danger">*</span></p>
                            <input type="text" class="form-control" id="up_depreciation_rate" name="up_depreciation_rate" min="0.1" max="99.9" required="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
