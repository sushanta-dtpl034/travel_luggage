                            ...
                            <div class="">
                                ...
                                <div class="col">
                                    <div class="row" style="text-align:right;">
                                        <div class="col-md-12" >
                                            <label> Search: </label>
                                            <input type="text" id="searchInput" class="" placeholder="Type keywords..." />
                                            <label> Role: </label> 
                                ...
                                <table id="assetincharge_table" class="table table-bordered border-t0 key-buttons text-nowrap w-100 table-responsive" >
                                    <thead>
                                        <tr>
                                            <th>S.No</th>
                                            <th>Name</th>
                ...
                <input type="hidden" class="form-control"  name="user_type" required="" id="up_usertype" value="4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control vendor_mobile"  name="mobile_number" required="" id="mobile_number" style="width:100%;" />
                            </div>
                        </div>
					</div>
                    <div class="col-md-6">
                    ...
                    <p class="mg-b-10">User Type <span class="tx-danger">*</span></p>
                        ...
                        <label class="custom-switch">
                                <input type="checkbox" value="1" id="admin" name="custom-switch-checkbox" class="custom-switch-input" name="basecompany"  id="basecompany">
                                <span class="custom-switch-indicator"></span>
                                <span class="custom-switch-description">Admin</span>
                                </label>
                            <label class="custom-switch">
                                <input type="checkbox" value="1" id="auditor"  name="custom-switch-checkbox" class="custom-switch-input" name="basecompany"  id="basecompany">
                                <span class="custom-switch-indicator"></span>
                                <span class="custom-switch-description">Auditor</span>
                                </label>
                                <label class="custom-switch">
                                <input type="checkbox" value="1" id="supervisor"  name="custom-switch-checkbox" class="custom-switch-input" name="basecompany"  id="basecompany">
                                <span class="custom-switch-indicator"></span>
				...
				<div class="row row-sm">
                    ...
                    <div class="col-md-6">     
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" style="display: none;" placeholder="Enter New Password" name="up_password"  id="up_password">
