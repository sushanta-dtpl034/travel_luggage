					...
					<td>
						<table style="width:100%">
							<tr>
								...
								<td width="60%">
									<p style="font-size:35px;"><b>'.$qrcodes_data->UniqueRefNumber.'</b></p>
									<!--<p style="font-size:55px;margin:0px;padding:0px;font-weight:900"><b>&bull;</b></p>-->	
									<table>
										<tr >
											<td style="font-size:22px;"><strong>Asset Name </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$qrcodes_data->AssetTitle.'</td>
										</tr>
										<tr >
											<td style="font-size:22px;"><strong>Location </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$qrcodes_data->Name.'</td>
										</tr>
										<tr >
											<td style="font-size:22px;"><strong>Category </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$qrcodes_data->AsseCatName.'</td>
										</tr>
										<tr >
											<td style="font-size:22px;"><strong>Sub Category </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$qrcodes_data->AssetSubcatName.'</td>
										</tr>
									</table>
								</td>
							</tr>
					...
					if($i == 0 && count($qrcodes_data) == 1){
						...
						<table style="width:100%">
							<tr>
								...
								<td width="60%">
									<p style="font-size:35px;"><b>'.$qrcodes_data[$i]->UniqueRefNumber.'</b></p>
									<table>
										<tr >
											<td style="font-size:22px;"><strong>Asset Name </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$qrcodes_data[$i]->AssetTitle.'</td>
										</tr>
										<tr >
											<td style="font-size:22px;"><strong>Location </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$qrcodes_data[$i]->Name.'</td>
										</tr>
										<tr>
											<td style="font-size:22px;" ><strong>Category </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$qrcodes_data[$i]->AsseCatName.'</td>
										</tr>
										<tr >
											<td style="font-size:22px;"><strong>Sub Category </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$qrcodes_data[$i]->AssetSubcatName.'</td>
										</tr>
									</table>	
								</td>
							</tr>
					...
					<tr >
						<td>
							<table style="width:100%">
								...
								<td width="60%">
									<p style="font-size:35px;"><b>'.$data->UniqueRefNumber.'</b></p>
									<table>
										<tr >
											<td style="font-size:22px;"><strong>Asset Name </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$data->AssetTitle.'</td>
										</tr>
										<tr >
											<td style="font-size:22px;"><strong>Location </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$data->Name.'</td>
										</tr>
										<tr>
											<td style="font-size:22px;" ><strong>Category </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$data->AsseCatName.'</td>
										</tr>
										<tr >
											<td style="font-size:22px;"><strong>Sub Category </strong></td>
											<td style="font-size:22px;"><strong>:</strong></td>
											<td style="font-size:22px;">'.$data->AssetSubcatName.'</td>
										</tr>
									</table>	
								</td>
							</tr>
