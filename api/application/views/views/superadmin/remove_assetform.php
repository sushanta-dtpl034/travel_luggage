...
<div class="container-fluid">
  ...
  <button class="btn ripple btn-primary" type="button" id="removeasset_button">Go</button>
  <!-- <span class="input-group-text" id="basic-addon2"></span> -->
                        ...
                        <table id="assest_details" class="table table-bordered border-t0 key-buttons text-nowrap w-100" style="display:none;">
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                                        <th>Unique Ref No</th>
