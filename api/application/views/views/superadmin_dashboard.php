					...
					<div class="card custom-card">
						<div class="card-body">
							<div class="card-order">
								<label class="main-content-label mb-3 pt-1">Total Qr Code</label>
								<h2 class="text-end"><a href="<?php echo base_url('Qrcode/index'); ?>"><i class="mdi mdi-cube icon-size float-start text-primary"></i><span class="font-weight-bold"><?php echo empty($dashboard_data->TOTAL_QRCODE)?0:$dashboard_data->TOTAL_QRCODE; ?></span></a></h2>
							</div>
						</div>
					</div>
				</div>
