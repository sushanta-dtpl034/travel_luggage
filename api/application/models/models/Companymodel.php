<?php
  class Companymodel extends CI_Model{
      ...
      public function getcompany($parent_id){
        ...
        $this->db->select('CompanyMst.AutoID,CompanyMst.CompanyName,CompanyMst.CompanyAddress,currency.CurrencyCode,CompanyMst.IsCompany');
      ...
      {
        $this->db->select('AutoID,CompanyName,CompanyAddress,CompanyLogo,CompanyStamp,BankDetails,CompanCurrency,IsCompany');
        $this->db->from('CompanyMst');
