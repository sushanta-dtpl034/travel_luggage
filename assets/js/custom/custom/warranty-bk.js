$( function() {
	...
	var service = $('#warrantytype_table').DataTable( {
		...
		"columns": [
            ...
            return '<button class="btn update_warrantytype bg-success" id="'+row.AutoID+'"  datatype="edit"><i class="si si-pencil"></i></button><button class="btn ripple delete_warrantytype btn-danger" id="'+row.AutoID+'"><i class="fe fe-trash"></i></button>';
          }
        }
