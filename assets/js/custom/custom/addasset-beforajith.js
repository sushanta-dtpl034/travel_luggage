...
$(function () {
    ...
    var service = $('#asset_table').DataTable({
        ...
        "ajax": {
            "url": base_url + "Assetmanagement/getasset_list",
            "type": "POST",
        ...
        },
        {
            "render": function (AutoID, type, row, meta) {
                ...
                // }
                 ...
                 if(usergroupid==4){
                    return '<!--<button class="btn  btn-sm print_qr bg-secondary mx-2" data-id="' + row.AutoID + '"  datatype="edit"><i class="si si-printer"></i></button>--><button class="btn bg-secondary" data-id="' + row.AutoID + '"  datatype="print"  onclick="printAssetQrcode(' + row.AutoID + ')"><i class="fa fa-qrcode fa-lg" aria-hidden="true"></i></button> <button class="btn btn-sm view_asset bg-success" id="' + row.AutoID + '"  datatype="edit"><i class="si si-eye"></i></button><a href="' + url + '"><button class="btn bg-warning"datatype="edit"><i class="si si-check"></i></button></a>';
                 }else{
                    return '<!--<button class="btn btn-sm print_qr bg-secondary mx-2" data-id="' + row.AutoID + '"  datatype="edit"><i class="si si-printer"></i></button>--><button class="btn bg-secondary" data-id="' + row.AutoID + '"  datatype="print"  onclick="printAssetQrcode(' + row.AutoID + ')"><i class="fa fa-qrcode fa-lg" aria-hidden="true"></i></button> <button class="btn btn-sm  view_asset bg-success" id="' + row.AutoID + '"  datatype="edit"><i class="si si-eye"></i></button> <button class="btn update_asset bg-info" id="' + row.AutoID + '"  datatype="edit"><i class="si si-pencil"></i></button> <a href="' + url + '"><button class="btn bg-warning"datatype="edit"><i class="si si-check"></i></button></a>';
                 }
